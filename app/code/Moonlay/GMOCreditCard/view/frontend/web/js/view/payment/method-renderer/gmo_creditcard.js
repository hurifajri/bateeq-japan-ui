        ...
        return Component.extend({
            ...
            validate: function() {
                ...
                if (allowedCountriesArray.indexOf(billingAddress.countryId) == -1 ||
                    ...
                    self.messageContainer.addErrorMessage({'message': 'Orders from this country are not supported by GMO Credit Card. Please select a different payment option.'});
                    return false;
                }

                if (totals.grand_total < 1) {
                    self.messageContainer.addErrorMessage({'message': 'GMO Credit Card doesn\'t support purchases less than ¥1.'});
                    return false;
                }
