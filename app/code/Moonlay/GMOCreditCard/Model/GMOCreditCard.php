...
class GMOCreditCard extends \Magento\Payment\Model\Method\AbstractMethod implements HandlerInterface
{
	...
	public function handle(array $handlingSubject, array $response)
	{
		...
		if ($parsed_header['response_code'] == '204') {
			...
			$error_message = 'GMO Credit Card refunding error: Failed Signature Check when communicating with the GMO gateway.';
			...
			$error_message = 'GMO Credit Card refunding error with returned message from gateway: '.$return_message.$return_message_explain;
		} else {
			$error_message = "GMO Credit Card refunding failed with unknown error.";
		}
